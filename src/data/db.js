// db.js — قاعدة البيانات المحلية (Dexie/IndexedDB) في متصفح المستخدم.
//
// التطبيق ده بيخزّن كل بياناته محليًا في المتصفح بس (لا يوجد سيرفر ولا
// حساب Firebase) — كل الـ repositories في src/data/repositories/*.js
// بتستورد من هنا مباشرة.
