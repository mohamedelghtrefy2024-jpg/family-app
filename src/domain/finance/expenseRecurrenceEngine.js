 ...
 *
 * BUG-03 FIX: كل التواريخ من هذا الملف Date-Only ("YYYY-MM-DD") ويجب التعامل معها كـ
 * Local Calendar Date وليس UTC timestamp — راجع src/domain/shared/dateUtils.js.
 * addDays/addMonths/clampDayOfMonth/isoDate المحليين اتشالوا لصالح النسخة المركزية
 * لتفادي وجود نسختين من نفس المنطق (بند 29 من طلب الإصلاح).
 */

import { addDays, addMonths, clampDayOfMonth, parseLocalDate, formatLocalDate } from "../shared/dateUtils.js";
