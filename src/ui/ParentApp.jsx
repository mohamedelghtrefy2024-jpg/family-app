...
const PAGES = [
  ...
  // بند Firebase Migration: صفحة إدارة أعضاء الأسرة (ربط يدوي) — للأب/الأم بس،
  // وهي أصلًا مش موجودة في نطاق ChildApp.jsx خالص (مش محجوبة، غير موجودة).
  { id: "familyMembers", label: "👨‍👩‍👧 أعضاء الأسرة" },
  ...
  return (
    <div className="app-shell">
      ...
      <main className="app-main">
        ...
        {page === "familyMembers" && <FamilyMembersPage />}
